...
function incrementalProductsProcessor(objects, builder, gatsbyApi, pluginOptions) {
    ...
    const productNodeIds = products.map(product => node_builder_1.createNodeId(product.id, gatsbyApi, pluginOptions));
    /**
    ...
    const variantsToDelete = gatsbyApi
        ...
        if (index >= 0) {
            ...
            const variantIds = variants
                ...
                .map(v => node_builder_1.createNodeId(v.id, gatsbyApi, pluginOptions));
