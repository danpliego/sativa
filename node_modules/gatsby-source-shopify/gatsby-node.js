...
async function sourceAllNodes(gatsbyApi, pluginOptions) {
    var _a, _b;
    const { createProductsOperation, createProductVariantsOperation, createOrdersOperation, createCollectionsOperation, finishLastOperation, completedOperation, cancelOperationInProgress, } = operations_1.createOperations(pluginOptions, gatsbyApi);
...
async function sourceChangedNodes(gatsbyApi, pluginOptions) {
    var _a, _b, _c, _d;
    const { incrementalProducts, incrementalProductVariants, incrementalOrders, incrementalCollections, finishLastOperation, completedOperation, cancelOperationInProgress, } = operations_1.createOperations(pluginOptions, gatsbyApi);
